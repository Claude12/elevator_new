	...
	<tr>
		...
		<td class="order-data">
			<table>
				...
				<?php if ( $courier ) : ?>
					<tr class="courier">
						<th><?php esc_html_e( 'Courier', 'elevator' ); ?></th>
...
<htmlpagefooter name="docFooter">
	<div id="footer">
		<p>Many thanks for your support and valued Purchase Order. For IMMEDIATE PERSONAL ATTENTION please phone 0116 266 2241 or fax 0116 266 2242</p>

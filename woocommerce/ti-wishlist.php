...
<div class="tinv-wishlist woocommerce tinv-wishlist-clear">
	...
	<input type="text" id="wishlist-search" class="wooacc-search" placeholder="Search favourites..."
		style="margin-top: 20px; padding: 8px; font-size: 17px;">
	...
	<p id="no-wishlist-message" style="display:none; text-align: center;">No matching items found.</p>
	<script>
		document.addEventListener("DOMContentLoaded", function () {
			const searchInput = document.getElementById("wishlist-search");
			const rows = document.querySelectorAll(".tinvwl-table-manage-list tbody tr");
			const noResults = document.getElementById("no-wishlist-message");

...
<?php if ($has_orders): ?>
	...
	<input type="text" id="order-search" class="wooacc-search" placeholder="Search order..."
		style="margin-bottom: 20px; padding: 8px; font-size: 14px;">
		...
		<tbody>
			...
			foreach ($customer_orders->orders as $customer_order) {
				...
				<tr
					...
					echo '<td class="order-products" style="display:none;">' . esc_html(implode(', ', $product_names)) . '</td>';
					?>
				</tr>
				<?php
			}
	...
	<!-- No Match Message -->
	<p id="no-orders-message" style="display:none; text-align: center; margin-top: 20px;">No matching orders found.</p>

	<script>
		document.addEventListener("DOMContentLoaded", function () {
			const searchInput = document.getElementById("order-search");
			const rows = document.querySelectorAll(".woocommerce-orders-table tbody tr");
